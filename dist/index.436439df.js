...
var _stable = require("core-js/stable"); // Polyfilling everthing else
var _runtime = require("regenerator-runtime/runtime"); // Polyfilling async/await
// https://forkify-api.herokuapp.com/v2
// ************************************ Section 18, Lecture 282: Loading a Recipe from API **************************** //
// if (module.hot) {
//   module.hot.accept();
// }
...
},{"./model.js":"6Yfb5","./config.js":"beA2m","./views/recipeView.js":"9q0mt","./views/searchView.js":"51HTZ","./views/resultsView.js":"a6WEO","./views/paginationView.js":"c2v8w","./views/bookmarksView.js":"cUfi0","./views/addRecipeView.js":"4NyJt","core-js/stable":"eIyVg","regenerator-runtime/runtime":"cH8Iq","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"6Yfb5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const loadRecipe = async function(id) {
    try {
        ...
        // console.log(data);
        //> let recipe = data.data.recipe // can be destructured since there are terms "data" on both sides of the assignment operator
    ...
    try {
        const ingredients = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith('ingredient') && entry[1] !== ''
            ...
            return {
                ...
                unit,
                description
            }; // If quantity is given, convert it into a number and store it in quanity or store null
        });
        const recipe = {
...
const KEY = '21ad9b33-506b-49ba-8eed-2e1bafd11eaa';
...
var _iconsSvg = require("url:../../img/icons.svg"); // Parcel version 2
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
// var Fraction = require('fractional').Fraction;
// import { Fraction } from '../../../node_modules/fractional'
// import { Fraction } from 'fractional';
var Fraction = require('fracty');
class RecipeView extends _viewDefault.default {
    ...
    addHandlerUpdateServings(handler) {
        this._parentElement.addEventListener('click', function(e) {
            ...
            // > No negative values for servings
    ...
    _generateMarkupIngredient(ing) {
        ...
        ing.quantity ? Fraction(ing.quantity).toString() : ''}</div>\n    <div class="recipe__description">\n      <span class="recipe__unit">${ing.unit}</span>\n      ${ing.description}\n    </div>\n  </li>`;
    }
}
exports.default = new RecipeView();

},{"./View":"8rtS4","url:../../img/icons.svg":"iwCpK","fracty":"cTuFN","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"8rtS4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg"); // Parcel version 2
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class View {
   ...
   * @this {Object} Instance of the View class
   * @author Jatinder Virdi
...
},{"./View":"8rtS4","./previewView.js":"knRyY","url:../../img/icons.svg":"iwCpK","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"knRyY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./View":"8rtS4","./previewView.js":"knRyY","url:../../img/icons.svg":"iwCpK","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"4NyJt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
